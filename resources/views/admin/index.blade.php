                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="recent-product-img">
                                            <img src="{{ asset('adminAssets/images/icons/chair.png') }}" alt="">
                                        </div>
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="recent-product-img">
                                            <img src="{{ asset('adminAssets/images/icons/shoes.png') }}" alt="">
                                        </div>
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="recent-product-img">
                                            <img src="{{ asset('adminAssets/images/icons/idea.png') }}" alt="">
                                        </div>
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="recent-product-img">
                                            <img src="{{ asset('adminAssets/images/icons/watch.png') }}" alt="">
                                        </div>
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="recent-product-img">
                                            <img src="{{ asset('adminAssets/images/icons/tshirt.png') }}" alt="">
                                        </div>
                                        <div class="ms-2">
