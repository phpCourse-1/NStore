                    ...
                    <div class="vendor-info">
                        ...
                        <div class="follow-social mb-20">
                            ...
                            <ul class="social-network">
                                <li class="hover-up">
                                    <a href="#">
                                        <img src="{{ asset('frontendAssets/images/theme/icons/social-tw.svg') }}"
                                            alt="" />
                                    </a>
                                </li>
                                <li class="hover-up">
                                    <a href="#">
                                        <img src="{{ asset('frontendAssets/images/theme/icons/social-fb.svg') }}"
                                            alt="" />
                                    </a>
                                </li>
                                <li class="hover-up">
                                    <a href="#">
                                        <img src="{{ asset('frontendAssets/images/theme/icons/social-insta.svg') }}"
                                            alt="" />
                                    </a>
                                </li>
                                <li class="hover-up">
                                    <a href="#">
                                        <img src="{{ asset('frontendAssets/images/theme/icons/social-pin.svg') }}"
                                            alt="" />
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div class="vendor-info">
                            <ul class="font-sm mb-20">
                                <li><img class="mr-5"
                                        src="{{ asset('frontendAssets/images/theme/icons/icon-location.svg') }}"
                                        alt="" /><strong>Address: </strong> <span>{{ $vendor->address }}</span>
                                </li>
                                <li><img class="mr-5"
                                        src="{{ asset('frontendAssets/images/theme/icons/icon-contact.svg') }}"
