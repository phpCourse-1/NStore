            ...
            <div class="carausel-10-columns" id="carausel-10-columns">
                <div class="card-2 bg-9 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                    <figure class="img-hover-scale overflow-hidden">
                        <a href="shop-grid-right.html"><img src="{{ asset('frontendAssets/images/shop/cat-13.png') }}"
                                alt="" /></a>
                    </figure>
                ...
                <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                    <figure class="img-hover-scale overflow-hidden">
                        <a href="shop-grid-right.html"><img src="{{ asset('frontendAssets/images/shop/cat-12.pn') }}g"
                                alt="" /></a>
                    </figure>
                ...
                <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                    <figure class="img-hover-scale overflow-hidden">
                        <a href="shop-grid-right.html"><img src="{{ asset('frontendAssets/images/shop/cat-11.png') }}"
                                alt="" /></a>
                    </figure>
                ...
                <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                    <figure class="img-hover-scale overflow-hidden">
                        <a href="shop-grid-right.html"><img src="{{ asset('frontendAssets/images/shop/cat-9.png') }}"
                                alt="" /></a>
                    </figure>
                ...
                <div class="card-2 bg-13 wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                    <figure class="img-hover-scale overflow-hidden">
                        <a href="shop-grid-right.html"><img src="{{ asset('frontendAssets/images/shop/cat-3.png') }}"
                                alt="" /></a>
                    </figure>
                ...
                <div class="card-2 bg-14 wow animate__animated animate__fadeInUp" data-wow-delay=".6s">
                    <figure class="img-hover-scale overflow-hidden">
                        <a href="shop-grid-right.html"><img src="{{ asset('frontendAssets/images/shop/cat-1.png') }}"
                                alt="" /></a>
                    </figure>
                ...
                <div class="card-2 bg-15 wow animate__animated animate__fadeInUp" data-wow-delay=".7s">
                    <figure class="img-hover-scale overflow-hidden">
                        <a href="shop-grid-right.html"><img src="{{ asset('frontendAssets/images/shop/cat-2.png') }}"
                                alt="" /></a>
                    </figure>
                ...
                <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".8s">
                    <figure class="img-hover-scale overflow-hidden">
                        <a href="shop-grid-right.html"><img src="{{ asset('frontendAssets/images/shop/cat-4.png') }}"
                                alt="" /></a>
                    </figure>
                ...
                <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".9s">
                    <figure class="img-hover-scale overflow-hidden">
                        <a href="shop-grid-right.html"><img src="{{ asset('frontendAssets/images/shop/cat-5.png') }}"
                                alt="" /></a>
                    </figure>
                ...
                <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay="1s">
                    <figure class="img-hover-scale overflow-hidden">
                        <a href="shop-grid-right.html"><img src="{{ asset('frontendAssets/images/shop/cat-14.png') }}"
                                alt="" /></a>
                    </figure>
                ...
                <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay="0s">
                    <figure class="img-hover-scale overflow-hidden">
                        <a href="shop-grid-right.html"><img src="{{ asset('frontend/') }}assets/images/shop/cat-5.png"
                                alt="" /></a>
                    </figure>
