...
<body>
                            ...
                            <div class="detail-gallery">
                                ...
                                <div class="product-image-slider">
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('frontendAssets/images/shop/product-16-2.jpg') }}"
                                            alt="product image" />
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('frontendAssets/images/shop/product-16-1.jpg') }}"
                                            alt="product image" />
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('frontendAssets/images/shop/product-16-3.jpg') }}"
                                            alt="product image" />
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('frontendAssets/images/shop/product-16-4.jpg') }}"
                                            alt="product image" />
                                    </figure>
                                    <figure class="border-radius-10">
                                    ...
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('frontendAssets/images/shop/product-16-6.jpg') }}"
                                            alt="product image" />
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('frontendAssets/images/shop/product-16-7.jpg') }}"
                                            alt="product image" />
                                    </figure>
                                </div>
                                <!-- THUMBNAILS -->
                                <div class="slider-nav-thumbnails">
                                    <div><img src="{{ asset('frontendAssets/images/shop/thumbnail-3.jpg') }}"
                                            alt="product image" /></div>
                                    <div><img src="{{ asset('frontendAssets/images/shop/thumbnail-4.jpg') }}"
                                            alt="product image" /></div>
                                    <div><img src="{{ asset('frontendAssets/images/shop/thumbnail-5.jpg') }}"
                                            alt="product image" /></div>
                                    <div><img src="{{ asset('frontendAssets/images/shop/thumbnail-6.jpg') }}"
                                            alt="product image" /></div>
                                    <div><img src="{{ asset('frontendAssets/images/shop/thumbnail-7.jpg') }}"
                                            alt="product image" /></div>
                                    <div><img src="{{ asset('frontendAssets/images/shop/thumbnail-8.jpg') }}"
                                            alt="product image" /></div>
                                    <div><img src="{{ asset('frontendAssets/images/shop/thumbnail-9.jpg') }}"
                                            alt="product image" /></div>
                                </div>
                            </div>
                            <!-- End Gallery -->
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul class="language-dropdown">
                                        <li>
                                            <a href="#"><img
                                                    src="{{ asset('frontendAssets/images/theme/flag-fr.png') }}"
                                                    alt="" />Français</a>
                                        </li>
                                        <li>
                                            <a href="#"><img
                                                    src="{{ asset('frontendAssets/images/theme/flag-dt.png') }}"
                                                    alt="" />Deutsch</a>
                                        </li>
                                        <li>
                                            <a href="#"><img
                                                    src="{{ asset('frontendAssets/images/theme/flag-ru.png') }}"
                                                    alt="" />Pусский</a>
                                        </li>
                                    </ul>
                                </li>
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                        <ul>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="shop-product-right.html"><img alt="Nest"
                                                            src="{{ asset('frontendAssets/images/shop/thumbnail-2.jpg') }}" /></a>
                                                </div>
                                                <div class="shopping-cart-title">
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                                ...
                                <div class="more_slide_open" style="display: none">
                                    <div class="d-flex categori-dropdown-inner">
                                        <ul>
                                            <li>
                                                <a href="shop-grid-right.html"> <img
                                                        src="{{ asset('frontendAssets/images/theme/icons/icon-1.svg') }}"
                                                        alt="" />Milks and Dairies</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img
                                                        src="{{ asset('frontendAssets/images/theme/icons/icon-2.svg') }}"
                                                        alt="" />Clothing & beauty</a>
                                            </li>
                                        </ul>
                                        <ul class="end">
                                            <li>
                                                <a href="shop-grid-right.html"> <img
                                                        src="{{ asset('frontendAssets/images/theme/icons/icon-3.svg') }}"
                                                        alt="" />Wines & Drinks</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img
                                                        src="{{ asset('frontendAssets/images/theme/icons/icon-4.svg') }}"
                                                        alt="" />Fresh Seafood</a>
                                            </li>
                                        </ul>
                                    </div>
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="shop-product-right.html"><img
                                                            src="{{ asset('frontendAssets/images/banner/banner-menu.png') }}"
                                                            alt="Nest" /></a>
                    ...
                    <div class="hotline d-none d-lg-flex">
                        <img src="{{ asset('frontendAssets/images/theme/icons/icon-headphone.svg') }}"
                            alt="hotline" />
        ...
        <div class="mobile-header-wrapper-inner">
            ...
            <div class="mobile-header-content-area">
                ...
                <div class="mobile-social-icon mb-50">
                    ...
                    <a href="#"><img
                            src="{{ asset('frontendAssets/images/theme/icons/icon-facebook-white.svg') }}"
                            alt="" /></a>
                    <a href="#"><img
                            src="{{ asset('frontendAssets/images/theme/icons/icon-twitter-white.svg') }}"
                            alt="" /></a>
                    <a href="#"><img
                            src="{{ asset('frontendAssets/images/theme/icons/icon-instagram-white.svg') }}"
                            alt="" /></a>
                    <a href="#"><img
                            src="{{ asset('frontendAssets/images/theme/icons/icon-pinterest-white.svg') }}"
                            alt="" /></a>
                    <a href="#"><img
                            src="{{ asset('frontendAssets/images/theme/icons/icon-youtube-white.svg') }}"
                            alt="" /></a>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="position-relative newsletter-inner">
                            ...
                            <img src="{{ asset('frontendAssets/images/banner/banner-9.png') }}" alt="newsletter" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6 mb-md-4 mb-xl-0">
                        <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp"
                            ...
                            <div class="banner-icon">
                                <img src="{{ asset('frontendAssets/images/theme/icons/icon-1.svg') }}"
                                    alt="" />
                            </div>
                    ...
                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                        <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp"
                            data-wow-delay=".1s">
                            <div class="banner-icon">
                                <img src="{{ asset('frontendAssets/images/theme/icons/icon-2.svg') }}"
                                    alt="" />
                            </div>
                            <div class="banner-text">
                    ...
                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                        <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp"
                            data-wow-delay=".2s">
                            <div class="banner-icon">
                                <img src="{{ asset('frontendAssets/images/theme/icons/icon-3.svg') }}"
                                    alt="" />
                            </div>
                            <div class="banner-text">
                    ...
                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                        <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp"
                            data-wow-delay=".3s">
                            <div class="banner-icon">
                                <img src="{{ asset('frontendAssets/images/theme/icons/icon-4.svg') }}"
                                    alt="" />
                            </div>
                            <div class="banner-text">
                    ...
                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                        <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp"
                            data-wow-delay=".4s">
                            <div class="banner-icon">
                                <img src="{{ asset('frontendAssets/images/theme/icons/icon-5.svg') }}"
                                    alt="" />
                            </div>
                            <div class="banner-text">
                    ...
                    <div class="col-lg-1-5 col-md-4 col-12 col-sm-6 d-xl-none">
                        <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp"
                            data-wow-delay=".5s">
                            <div class="banner-icon">
                                <img src="{{ asset('frontendAssets/images/theme/icons/icon-6.svg') }}"
                                    alt="" />
                            </div>
                            <div class="banner-text">
                        ...
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp"
                            ...
                            <div class="logo mb-30">
                                <a href="index.html" class="mb-15"><img
                                        src="{{ asset('frontendAssets/images/theme/logo.svg') }}"
                                        alt="logo" /></a>
                                <p class="font-lg text-heading">Awesome grocery store website template</p>
                            </div>
                            <ul class="contact-infor">
                                <li><img src="{{ asset('frontendAssets/images/theme/icons/icon-location.svg') }}"
                                        alt="" /><strong>Address: </strong> <span>5171 W Campbell Ave undefined
                                        Kent, Utah 53127 United States</span></li>
                                <li><img src="{{ asset('frontendAssets/images/theme/icons/icon-contact.svg') }}"
                                        alt="" /><strong>Call Us:</strong><span>(+91) - 540-025-124553</span>
                                </li>
                                <li><img src="{{ asset('frontendAssets/images/theme/icons/icon-email-2.svg') }}"
                                        alt="" /><strong>Email:</strong><span>sale@Nest.com</span></li>
                                <li><img src="{{ asset('frontendAssets/images/theme/icons/icon-clock.svg') }}"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-lg-6 text-center d-none d-xl-block">
                    ...
                    <div class="hotline d-lg-inline-flex">
                        <img src="{{ asset('frontendAssets/images/theme/icons/phone-call.svg') }}" alt="hotline" />
    ...
    <div id="preloader-active">
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                <div class="text-center">
                    <img src="{{ asset('frontendAssets/images/theme/loading.gif') }}" alt="" />
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="{{ asset('frontendAssets/js/plugins/slick.js') }}"></script>
    <script src="{{ asset('frontendAssets/js/plugins/jquery.syotimer.min.js') }}"></script>
    <script src="{{ asset('frontendAssets/js/plugins/waypoints.js') }}"></script>
    <script src="{{ asset('frontendAssets/js/plugins/wow.js') }}"></script>
    <script src="{{ asset('frontendAssets/js/plugins/perfect-scrollbar.js') }}"></script>
    ...
    <script src="{{ asset('frontendAssets/js/plugins/counterup.js') }}"></script>
    <script src="{{ asset('frontendAssets/js/plugins/jquery.countdown.min.js') }}"></script>
    <script src="{{ asset('frontendAssets/js/plugins/images-loaded.js') }}"></script>
    ...
    <script src="{{ asset('frontendAssets/js/plugins/jquery.vticker-min.js') }}"></script>
    <script src="{{ asset('frontendAssets/js/plugins/jquery.theia.sticky.js') }}"></script>
    <script src="{{ asset('frontendAssets/js/plugins/jquery.elevatezoom.js') }}"></script>
    <!-- Template  JS -->
